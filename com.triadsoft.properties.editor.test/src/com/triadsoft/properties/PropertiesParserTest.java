...
public class PropertiesParserTest extends TestCase {
	...
	public void setUp() throws Exception {
		...
		pf = new PropertiesFile(file);
		properties = new PropertiesFile(getClass().getResourceAsStream(
...
//		PropertyCategory1 cat = null;
//		for (int i = 0; i < pf.getChildren().length; i++) {
//			PropertyCategory1 category = (PropertyCategory1) pf.getChildren()[i];
...
//				properties.getCategories().size() > 0);
	...
	public void testPropertiesRich() {
		...
		PropertiesFile rich = new PropertiesFile(getClass()
